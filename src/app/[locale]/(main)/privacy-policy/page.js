  ...
  return (
    <div className="container px-5 lg:px-10 sm:pt-[100px] pt-[65px] relative z-[1]">
      ...
      <div className="container px-5 lg:px-10 py-14 text-justify">
        <div className="text-xl font-bold pt-8 pb-4">
          {bangla ? (
            <>
              ...
              আপনার গোপনীয়তা রক্ষা করা আমাদের প্রধান অগ্রাধিকার। এই ডকুমেন্টে আমরা কিভাবে আপনার
              তথ্য সংগ্রহ, ব্যবহার এবং নিরাপদ রাখি তা বর্ণনা করা হয়েছে, যখন আমরা বাংলাদেশের সেরা
              ই-কমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম প্রদান করি।
            </>
          ) : (
            <>
              Welcome to eBitans! <br />
              Protecting your privacy is our top priority. This document outlines how we collect,
              use, and safeguard your data while providing the best eCommerce website builder in
              Bangladesh.
            </>
          )}
        </div>
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">{bangla ? 'ভূমিকা' : 'Introduction'}</h3>
          <p>
            {bangla ? (
              <>
                ...
                পরিচালনা করে, যা “সার্ভিস” হিসেবে পরিচিত। এই প্রাইভেসি পলিসি আমাদের সার্ভিস ব্যবহার
                করার সময় আপনার তথ্য কিভাবে পরিচালনা করি তা ব্যাখ্যা করে। আমাদের সার্ভিসে প্রবেশ
                করার মাধ্যমে আপনি এখানে বর্ণিত তথ্য সংগ্রহ, ব্যবহার এবং প্রকাশের অনুশীলনগুলিতে সম্মত
                হন।
              </>
            ) : (
              <>
                ...
                , referred to as “Service.” This Privacy Policy explains how we handle your
                information when you use our Service. By accessing our Service, you agree to our
                collection, use, and disclosure practices described here.
              </>
            )}
          </p>
        </div>
        ...
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">{bangla ? 'সংজ্ঞা' : 'Definitions'}</h3>
          <p>
            {bangla ? (
              <>
                <span className="font-bold">সার্ভিস:</span> eBitans দ্বারা পরিচালিত ওয়েবসাইট{' '}
                <a
                  href="https://www.ebitans.com.bd"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <p>
            {bangla ? (
              <>
                ...
                এমন তথ্য যা সরাসরি বা পরোক্ষভাবে একজন ব্যক্তিকে চিহ্নিত করতে পারে।
              </>
            ) : (
              <>
          ...
          <p>
            {bangla ? (
              <>
                ...
                আমাদের সার্ভিসের সাথে আপনার ইন্টারঅ্যাকশনের ব্যাপারে স্বয়ংক্রিয়ভাবে সংগ্রহ করা
                তথ্য, যেমন পেজ ভিজিটের সময়কাল।
              </>
            ) : (
              <>
                <span className="font-bold">USAGE DATA: </span>
                Automatically collected data about your interaction with our Service, such as page
                visit duration.
              </>
            )}
          </p>
          <p>
            {bangla ? (
              <>
                ...
                eBitans সিদ্ধান্ত নেয় কেন এবং কিভাবে আপনার ব্যক্তিগত তথ্য প্রক্রিয়া করা হবে।
              </>
            ) : (
              <>
        ...
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">
            {bangla ? 'তথ্য সংগ্রহ এবং ব্যবহার' : 'Information Collection and Use'}
          </h3>
          <p>
            {bangla
        ...
        <div>
          ...
          <p className="font-bold">{bangla ? 'ব্যক্তিগত তথ্য' : 'Personal Data'}</p>
          <br />
          <p>
            {bangla
          ...
          <h4 className="font-bold py-2">{!bangla ? 'Other Data' : 'অন্যান্য তথ্য'}</h4>
          <h5 className="font-semibold">
            {!bangla ? 'May include:' : 'এতে অন্তর্ভুক্ত হতে পারে:'}
          </h5>
          <div>
            <ul className="list-disc pl-6">
              <li>{!bangla ? 'Age, gender, or date of birth.' : 'বয়স, লিঙ্গ বা জন্ম তারিখ।'}</li>
              <li>
                {!bangla ? 'Employment or education details.' : 'কর্মসংস্থান বা শিক্ষার বিবরণ।'}
              </li>
              <li>{!bangla ? 'Marital status or citizenship.' : 'বৈবাহিক অবস্থা বা নাগরিকত্ব।'}</li>
            </ul>
          </div>
        ...
        <div>
          ...
          <p className="font-bold">
            {!bangla ? 'Automatically collected, such as:' : 'স্বয়ংক্রিয়ভাবে সংগ্রহ করা, যেমন:'}
          </p>
          <ul className="list-disc pl-6">
            <li>{!bangla ? 'Browser type' : 'ব্রাউজারের ধরন'}</li>
            <li>{!bangla ? 'Pages visited' : 'প্রদর্শিত পেজগুলো'}</li>
            <li>{!bangla ? 'Time spent on our site' : 'আমাদের সাইটে ব্যয় করা সময়'}</li>
          </ul>
        </div>
            ...
            {!bangla ? (
              <>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>Personal Data: Stored until no longer needed or per legal requirements.</li>
                  <li>
                    Usage Data: Typically kept for shorter periods unless used for security or
              ...
              <>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>
                    ব্যক্তিগত তথ্য: যতক্ষণ প্রয়োজন বা আইনগত প্রয়োজন অনুযায়ী সংরক্ষণ করা হয়।
                  </li>
                  <li>
                    ব্যবহারের তথ্য: সাধারণত স্বল্প সময়ের জন্য সংরক্ষণ করা হয়, যদি না এটি নিরাপত্তা
                    বা কার্যক্রম উন্নতির জন্য ব্যবহৃত হয়।
                  </li>
                </ul>
              </>
            )}
        ...
        <div>
          ...
          <br />
          <li className="font-bold">{!bangla ? 'Legal Requirements:' : 'আইনগত প্রয়োজনীয়তা:'}</li>
          <p className="pl-5">
            {!bangla
              ? 'In response to lawful requests or obligations.'
              : 'বৈধ অনুরোধ বা বাধ্যবাধকতার জন্য।'}
          </p>
          <li className="font-bold">{!bangla ? 'Business Transactions:' : 'ব্যবসায়িক লেনদেন:'}</li>
          <p className="pl-5">
            {!bangla
              ? 'In cases of mergers, acquisitions, or asset transfers.'
              : 'একত্রিতকরণ, অধিগ্রহণ, বা সম্পদ স্থানান্তরের ক্ষেত্রে।'}
          </p>
          <li className="font-bold">{!bangla ? 'Other Parties:' : 'অন্যান্য পক্ষ:'}</li>
          <div className="pl-5">
            <li>
              {!bangla
            ...
            <li>{!bangla ? 'With your explicit consent.' : 'আপনার স্পষ্ট সম্মতির মাধ্যমে।'}</li>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">
            {!bangla ? 'Third-Party Service Providers' : 'তৃতীয়-পক্ষ সেবা প্রদানকারী'}
          </h3>
          <p>
            {!bangla ? (
              <>
        ...
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">
            {!bangla ? 'Changes to This Privacy Policy' : 'এই প্রাইভেসি পলিসিতে পরিবর্তন'}
          </h3>
          <p>
            {!bangla
        ...
        <div>
          ...
          <p>
            {!bangla ? (
              <>
                We offer comprehensive after-sales support for our services, including:
                <ul className="list-disc pl-5">
                  <li>Assistance with technical issues.</li>
                  <li>
                    Guidance for using our eCommerce website builder in Bangladesh effectively.
                  </li>
                </ul>
                For further inquiries or concerns, reach out via our contact page or email.
              </>
            ) : (
              <>
                আমরা আমাদের সেবার জন্য ব্যাপক পরবর্তী বিক্রয় সহায়তা প্রদান করি, যার মধ্যে রয়েছে:
                <ul className="list-disc pl-5">
                  <li>টেকনিক্যাল সমস্যা সমাধানে সহায়তা।</li>
                  <li>
                    বাংলাদেশে আমাদের ইকমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম কার্যকরভাবে ব্যবহার করার
                    জন্য গাইডেন্স।
                  </li>
                </ul>
                আরও যেকোনো প্রশ্ন বা উদ্বেগের জন্য, আমাদের যোগাযোগ পৃষ্ঠায় বা ইমেইলে যোগাযোগ করুন।
              </>
            )}
          </p>
        </div>
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">
            {!bangla ? 'Your Privacy, Our Priority' : 'আপনার গোপনীয়তা, আমাদের অগ্রাধিকার'}
          </h3>
          <p>
            {!bangla ? (
              <>
                At eBitans, we prioritize transparency and user trust. Explore our Service
                confidently, knowing your data is in safe hands.
                <br />
                Get started today with the best eCommerce website builder in Bangladesh and enjoy
                top-tier support!
              </>
            ) : (
              <>
                eBitans-এ আমরা স্বচ্ছতা এবং ব্যবহারকারীর বিশ্বাসকে অগ্রাধিকার দেই। আত্মবিশ্বাসের
                সাথে আমাদের সার্ভিস এক্সপ্লোর করুন, জানুন আপনার তথ্য নিরাপদ হাতে।
                <br />
                আজই শুরু করুন বাংলাদেশের সেরা ইকমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম এবং উপভোগ করুন
                শীর্ষস্থানীয় সহায়তা!
              </>
            )}
          </p>
        ...
        <div>
          <h3 className="text-3xl font-bold pt-8 pb-4">{bangla ? 'যোগাযোগ করুন' : 'Contact Us'}</h3>
          <p>
            {bangla ? (
              <>
                এই প্রাইভেসি পলিসি সম্পর্কে যদি আপনার কোনো প্রশ্ন থাকে, তাহলে অনুগ্রহ করে আমাদের
                সাথে যোগাযোগ করুন:
                <br />
