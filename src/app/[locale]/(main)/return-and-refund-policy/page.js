    ...
    <div className="container px-5 lg:px-10 sm:pt-[100px] pt-[65px] relative z-[1]">
      ...
      <div className="container px-5 lg:px-10 pt-10 text-justify">
        <h3 className="text-3xl font-bold pt-8 pb-4">
          {!bangla ? 'Try Before You Subscribe' : 'সাবস্ক্রাইব করার আগে চেষ্টা করুন'}
        </h3>
        <p className="text-m sm:text-lg md:text-xl lg:text-2xl">
          {!bangla ? (
            <>
              ...
              , the best eCommerce website builder in Bangladesh, offers a 7-days free trial to help
              you explore all our platform's features. This trial period allows you to experience
              the benefits and decide if our services are the perfect fit for your online business.
            </>
          ) : (
            <>
              <a
              ...
              , বাংলাদেশের সেরা ইকমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম, আমাদের প্ল্যাটফর্মের সমস্ত
              বৈশিষ্ট্য অন্বেষণ করতে ৭ দিনের ফ্রি ট্রায়াল অফার করছে। এই ট্রায়াল সময়কালে আপনি
              আমাদের সেবাগুলির সুবিধা অনুভব করতে পারবেন এবং সিদ্ধান্ত নিতে পারবেন যে আমাদের সেবাগুলি
              আপনার অনলাইন ব্যবসার জন্য আদর্শ কিনা।
            </>
          )}
        </p>
      </div>
        ...
        <div className="text-m sm:text-lg md:text-xl lg:text-2xl">
          {!bangla ? (
            <ul className="list-disc pl-6">
              ...
              <li>No Return Policy Needed: The trial ensures satisfaction upfront.</li>
              <li>Cancel Anytime: Flexible and customer-focused service.</li>
              <li>Best website builder in Bangladesh: Tailored for businesses like yours.</li>
            </ul>
          ) : (
            <ul className="list-disc pl-6">
              <li>৭ দিন ফ্রি ট্রায়াল: আমাদের প্ল্যাটফর্ম ঝুঁকি মুক্তভাবে পরীক্ষা করুন।</li>
              <li>ক্ষমতাবান সিদ্ধান্ত: আত্মবিশ্বাসের সাথে পরীক্ষা করুন এবং সিদ্ধান্ত নিন।</li>
              <li>রিটার্ন পলিসি প্রয়োজন নেই: ট্রায়াল থেকেই সন্তুষ্টি নিশ্চিত।</li>
              <li>যেকোনো সময় ক্যান্সেল করুন: নমনীয় এবং গ্রাহক-কেন্দ্রিক সেবা।</li>
              <li>বাংলাদেশের সেরা ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম: আপনার ব্যবসার জন্য উপযোগী।</li>
            </ul>
          )}
        </div>
