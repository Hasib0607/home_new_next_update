...
const PosPricing = ({ pos }) => {
  ...
  return (
    <div className="relative">
      <div
        className={`w-[345px] h-[345px] bg-[#F3BEB3] bg-opacity-50 blur-3xl rounded-full absolute -left-[160px] top-40 `}
      ></div>
      <div className="container px-5 lg:px-10 py-10 lg:py-[120px] relative z-[5] rounded-md">
        ...
        >
          ...
          <FaArrowDown
            className={`${open ? 'rotate-180' : ''} duration-1000 text-[#f1593a] text-3xl`}
          />
        </div>
        <div className={`${open ? 'h-full' : 'h-0'} overflow-hidden px-5 bg-white`}>
          <div
            className={`${open ? 'translate-y-0' : 'translate-y-10'} duration-1000 grid grid-cols-1 lg:grid-cols-3 items-center justify-center gap-10 pt-5 lg:pt-[65px] w-full`}
          >
            <div className="w-full flex lg:justify-center">
              <div>
                <h5 className={`${styles.archivo} ${styles.headerFive} font-semibold mb-6`}>
                  All in One Solution
                </h5>
          ...
          <div
            className={`${open ? 'translate-y-0' : 'translate-y-10'} duration-1000 relative z-[4] py-[65px]`}
          >
            <div className="flex items-center rounded-md border border-[#442721] justify-center w-max mx-auto px-2 py-1 mb-[65px]">
              <button
                ...
                className={`${plan === 'onedis' && 'bg-[#f1593a] text-white'} px-2 py-1 rounded-[3px] border border-transparent`}
              >
                Monthly
              </button>
              <button
                onClick={() => setPlan('twelvedis')}
                className={`${plan === 'twelvedis' && 'bg-[#f1593a] text-white'} px-2 py-1 rounded-[3px] border border-transparent`}
              >
                Annually
              </button>
            </div>
    ...
    <div className="w-full space-y-4 mt-5">
      ...
      <div className="py-3 space-y-3 mx-10">
        ...
        <div className="flex items-center gap-x-3 text-xs">
          ...
          <p
            className={`${styles.paragraph} ${pricing?.advance_report === 'No' && 'text-[#8F8F8F]'} ${styles.archivo}`}
          >
            Advance Report
          </p>
        </div>
        <div className="flex items-center gap-x-3 text-xs">
          ...
          <p
            className={`${styles.paragraph} ${pricing?.website_setup === 'No' && 'text-[#8F8F8F]'} ${styles.archivo}`}
          >
            Website Setup
          </p>
        </div>
