...
export default function Testimonials() {
  ...
  return (
    <section className="relative overflow-hidden">
      <div
        className={`absolute -right-32 lg:-right-20 top-14 lg:top-20 z-[5] w-[345px] h-[345px] bg-[#F3BEB3] bg-opacity-50 blur-3xl rounded-full`}
      ></div>
        ...
        <div className="relative">
          <div className="relative lg:pt-40 pt-20">
            ...
            <Image
              src={images?.user1}
              alt="ebitans image"
              className="absolute h-4 lg:h-auto w-auto top-14 lg:top-20 left-[62%]"
            />
            <Image
              src={images?.user2}
              alt="ebitans image"
              className="absolute h-4 lg:h-auto w-auto bottom-5 lg:bottom-0 left-[80%]"
            />
            <Image
              src={images?.user3}
              alt="ebitans image"
              className="absolute h-4 lg:h-auto w-auto left-[15%] bottom-0 lg:-bottom-5"
            />
            <Image
              src={images?.user4}
              alt="ebitans image"
              className="absolute h-4 lg:h-auto w-auto left-[45%] -bottom-10 lg:-bottom-32"
            />
          </div>
        </div>
      </div>
