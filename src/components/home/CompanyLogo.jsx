        ...
        {brands?.map((items, id) => (
          <div key={id} className="company-image relative mx-10 lg:mx-24 group h-20 lg:h-32">
            <Image
              ...
              src={items}
              alt="ebitans image"
              className="h-16 w-auto grayscale group-hover:grayscale-0"
            />
            <Image
              placeholder="blur"
              src={items}
              alt="ebitans image"
              className="h-16 w-auto absolute top-[50%] left-0 scale-y-[-1] opacity-10 grayscale group-hover:grayscale-0"
            />
