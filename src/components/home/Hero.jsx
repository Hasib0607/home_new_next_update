      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-5 2xl:items-center pb-10 lg:pb-[120px] pt-16 lg:pt-32 2xl:pt-56 relative container px-5 lg:px-10">
        <div className="relative order-last lg:order-first lg:justify-self-start justify-self-center w-full">
          ...
          >
            {bangla ? (
              <>
                eBitans - বাংলাদেশের সবচেয়ে জনপ্রিয় ইকমার্স ওয়েবসাইট তৈরির প্ল্যাটফর্ম।
                <br className="sm:hidden" />
                মাত্র ১ মিনিটে সহজেই আপনার{' '}
                <span className={`${styles.archivo} text-[#f1593a] font-black`}>অনলাইন স্টোর </span>
                তৈরি করুন!
              </>
            ) : (
              <>
          ...
          >
            {bangla ? (
              <>
                আপনি কি বাংলাদেশের সেরা ইকমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্ম খুঁজছেন? eBitans সহজেই
                একটি ব্যবহারবান্ধব অনলাইন স্টোর তৈরি করতে সহায়তা করে। আপনার পণ্য প্রদর্শন করুন,
                ব্যবসা বৃদ্ধি করুন, এবং{' '}
                <a
                  href="/pricing"
              ...
              <>
                Are you looking for the best eCommerce website builder in Bangladesh? eBitans makes
                it easy to create a user-friendly online store. Showcase your products, grow your
                business, and{' '}
                <a
                  href="/pricing"
                ...
                Build your eCommerce website with the best eCommerce website builder, Get powerful
                tools to serve your customers and grow your business effortlessly!
              </>
            )}
          </p>
