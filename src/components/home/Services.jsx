        ...
        <div className="bg-[#0E144B] my-10 relative z-[1] grid grid-cols-1 lg:grid-cols-2 rounded-lg  mx-auto p-5">
          <div className="text-white relative w-full h-full">
            ...
            <div className="space-y-8 lg:absolute top-10 max-w-[400px] p-5 lg:p-0">
              <h2 className={`${styles.archivo} ${styles.headerTwo} leading-10`}>
                {bangla ? (
                  <>
              ...
              <p>
                {bangla ? (
                  <>
                    eBitans-এর মাধ্যমে আপনার নিজস্ব ইকমার্স ওয়েবসাইট তৈরি করুন। আমাদের সেরা ইকমার্স
                    ওয়েবসাইট নির্মাণ প্ল্যাটফর্মটি আপনাকে আপনার ব্যবসা শুরু, পরিচালনা এবং বৃদ্ধি
                    করার জন্য প্রয়োজনীয় সকল ফিচার প্রদান করে। eBitans শুধুমাত্র ছোট এবং মাঝারি
                    ...
                    , ডিজাইন লেআউট, মোবাইল অ্যাপস, ইমেজ কাস্টমাইজেশন এবং আরও অনেক কিছু।
                  </>
                ) : (
                  <>
                    Create your own eCommerce website with eBitans. Our best eCommerce website
                    builder platform provides all the features you need to start, manage, and grow
                    your business. eBitans is not just a website builder for small and medium
                    businesses—we{' '}
                    <a
                      href="/pricing"
                      className="text-[#f1593a] underline hover:text-[#f1463a]"
                    ...
                    , design layouts, mobile apps, image customization, and much more.
                  </>
                )}
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2 md:gap-y-0  p-2 md:p-0  w-full h-full py-5">
            <div className="bg-[#FF7069] w-full min-h-[407px] rounded-lg md:rounded-none md:rounded-tl-lg relative">
              ...
              <div className="flex justify-between items-end gap-2 absolute bottom-5 right-5 left-5">
                <h3 className={`${styles.archivo} text-base font-bold md:text-2xl`}>
                  Point Of Sale (POS)
                </h3>
