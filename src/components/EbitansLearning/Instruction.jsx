        ...
        {instruction?.map((item) => (
          <Accordion.Panel key={item?.id} className="relative border-b-0">
            ...
            <Accordion.Container className="text-left">
              <h3
                onClick={() => setActive((prevId) => (prevId === item?.id ? null : item?.id))}
            ...
            >
              <div>
                <p className="text-black">{bangla ? item?.subTitleBn : item?.subTitle}</p>
                <button
...
const instruction = [
  ...
  },
  {
    ...
    subTitle:
      'Add products with clear images, simple descriptions, and correct prices to improve visibility and SEO.',
    subTitleBn:
      'স্পষ্ট ছবি, সোজা বিবরণ এবং সঠিক দাম সহ পণ্য যোগ করুন, যাতে ভিজিবিলিটি এবং SEO উন্নত হয়।',
  ...
  },
  {
    ...
    subTitleBn:
      'আমাদের থিম স্টোর থেকে একটি চমকপ্রদ থিম নির্বাচন করুন এবং শুধু কয়েকটি ক্লিকে সহজেই এটি কাস্টমাইজ করুন, যাতে আপনার ওয়েবসাইটকে একটি অনন্য এবং পেশাদারী চেহারা দেওয়া যায়।',
  ...
  },
  {
    ...
    subTitleBn:
      'আপনার ওয়েবসাইটটি কাস্টমাইজ করুন হেডার মেনু নির্বাচন করে এবং একটি থিম রঙ নির্বাচন করে যা আপনার স্টাইলের সাথে মানানসই, যাতে একটি ব্যক্তিগতকৃত লুক এবং অনুভূতি তৈরি হয়।',
  ...
  },
  {
    ...
    subTitleBn:
      'আপনার পণ্যগুলো কার্যকরভাবে প্রচার করতে এবং গ্রাহকদের মনোযোগ আকর্ষণ করতে স্লাইডার এবং ব্যানার ছবি যোগ করুন।',
  ...
  },
  {
    ...
    subTitleBn:
      "আপনার ব্যবসার জন্য গুরুত্বপূর্ণ পেজ তৈরি করুন, যেমন 'আমাদের সম্পর্কে', 'শর্তাবলী', এবং 'যোগাযোগ', যাতে গুরুত্বপূর্ণ তথ্য প্রদান করতে পারেন এবং আপনার দর্শকদের সাথে বিশ্বাস তৈরি করতে পারেন।",
    video: '',
  },
  {
    id: 10,
    ...
    subTitle:
      'Finally, connect your custom domain to establish your brand and expand your business globally.',
    subTitleBn:
      'অবশেষে, আপনার কাস্টম ডোমেন সংযুক্ত করুন আপনার ব্র্যান্ড প্রতিষ্ঠিত করতে এবং আপনার ব্যবসা বিশ্বব্যাপী সম্প্রসারণ করতে।',
