  ...
  return (
    <div className="container px-5 lg:px-10 lg:py-20 py-5">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className=""></div>
        <div className="">
          <h1 className="lg:text-[40px] text-[30px] font-bold">
            Maximum integration at a minimum cost
          </h1>
          <p className="my-10 text-lg">
            Sign up for a free affiliate program link. And whenever a new merchant upgrades to an
            eBitans paid plan through your link, you’ll receive a 20% commission for the life of
            their store. Plus, you’ll get access to our affiliate dashboard to track all your
            referrals, and watch your earnings grow.
          </p>
        </div>
      </div>
      <div className="">
        <Image
          ...
          src={images?.pc}
          alt="ebitans image"
          className="lg:hidden mx-auto h-full w-full"
        />
      </div>
        ...
        <div className="bg-[#F1593A] px-5 py-10 grid lg:grid-cols-2 rounded-lg mt-5">
          <div className="relative">
            <Image
              ...
              src={images?.pc}
              alt="ebitans image"
              className="lg:absolute hidden lg:block lg:-top-[400px] left-0 h-auto w-auto"
            />
          </div>
