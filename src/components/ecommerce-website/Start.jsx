    ...
    <div className="bg-[#FAD8D1] lg:pt-20 lg:pb-28 pb-10 pt-10">
      <div className="container px-5 lg:px-10 relative z-[1] hidden lg:block">
        ...
        <div className="flex justify-between items-center gap-x-5">
          ...
          <p className="xl:max-w-[350px] max-w-[250px]">
            Become one of thousands of eBitans Affiliates and teach entrepreneurs how to build
            incredible businesses online with eBitans E-commerce.
          </p>
        </div>
        <div>
      ...
      <div className="md:px-10 px-5 block lg:hidden ">
        <h1 className="text-[30px] font-bold">
          EASY TO MANUFACTURE <br /> BEST FOR ENTREPRENEUR
        </h1>
        <p className="md:max-w-[350px] my-3">
          Become one of thousands of eBitans Affiliates and teach entrepreneurs how to build
          incredible businesses online with eBitans E-commerce.
        </p>
        <div className="relative w-max">
