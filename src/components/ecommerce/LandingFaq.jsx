            ...
            {faqdata.slice(0, 5)?.map((item) => (
              ...
              >
                <Accordion.Container className="text-left bg-[#f1593a]">
                  <h3
                    className={`${styles.archivo} text-lg md:text-2xl mr-2 font-semibold`}
                  >
                    {item?.titleBn}
                  </h3>
                  <Accordion.Icon />
...
<br>আপনার ওয়েবসাইটে ভিজিটরের সংখ্যা যত বেশি হবে ততো বেশি ব্যান্ডউইথ বেশি খরচ হবে।`,
  ...
  <ul class="list-disc ml-5 mt-2">
    <li>আপনার eBitans অ্যাডমিন প্যানেলে লগইন করুন: 
      <a href="https://admin.ebitans.com" class="text-[#f1593a] underline">https://admin.ebitans.com</a> ওয়েবসাইটে গিয়ে আপনার ড্যাশবোর্ডে প্রবেশ করুন।
    </li>
    <li>পণ্য ম্যানেজমেন্ট সেকশনে যান: সাইডবার মেনু থেকে "Products" ট্যাবে ক্লিক করুন।</li>
    <li>নতুন পণ্য যোগ করুন: "Add Product" বাটনে ক্লিক করুন।</li>
    <li>পণ্যের বিবরণ পূরণ করুন:
      <ul class="list-disc ml-5">
        <li>পণ্যের নাম</li>
        <li>বর্ণনা</li>
        <li>মূল্য</li>
        <li>SKU (স্টক কিপিং ইউনিট)</li>
        <li>স্টকের পরিমাণ</li>
        <li>ক্যাটাগরি এবং সাবক্যাটাগরি</li>
        <li>ভেরিয়েন্ট (যেমন: সাইজ, রঙ)</li>
        <li>পণ্যের ছবি আপলোড করুন</li>
      </ul>
    </li>
    <li>অতিরিক্ত সেটিংস কনফিগার করুন:
      <ul class="list-disc ml-5">
        <li>ডিসকাউন্ট বা প্রমোশনাল মূল্য সেট করুন (যদি থাকে)।</li>
        <li>শিপিং অপশন এবং খরচ নির্ধারণ করুন।</li>
        <li>প্রয়োজন অনুযায়ী ট্যাক্স সেটিংস ঠিক করুন।</li>
      </ul>
    </li>
    <li>সেভ এবং প্রকাশ করুন: সমস্ত তথ্য পূরণের পর "Publish" বাটনে ক্লিক করে পণ্যটি আপনার অনলাইন স্টোরে প্রকাশ করুন।</li>
  </ul>`,
  },
  {
    id: 9,
    titleBn: "ওয়েবসাইট পরিচালনা করার জন্য কোনও টিটোরিয়াল আছে?",
    descBn: `<div class="pb-8">কিভাবে আপনি আপনার ওয়েবসাইট পরিচালনা করবেন তার বিস্তারিত আমাদের Youtube চ্যানেলে দেয়া আছে।<br><br> Youtube চ্যানেলের লিংক: <a href="https://www.youtube.com/channel/UCNYZdTPddwoGeMWy5cQ733w" class="text-[#f1593a] underline" target="_blank">Visit Youtube Tutiorial</a> </div>`,
  },
];
