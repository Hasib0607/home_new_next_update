      ...
      <div className="grid lg:grid-cols-2 gap-x-14 gap-y-10 place-items-center lg:pt-20 lg:pb-20 pt-10 pb-20 container px-5 lg:px-10">
        <div className="lg:justify-self-start justify-self-center space-y-4">
          ...
          <p className="max-w-[500px]">
            {!bangla ? (
              <>
                eBitans welcomes everyone, including store owners, website managers, influencers,
                bloggers, sales graduates, and freelancers. No experience is needed to get started.
                It’s completely free to join and simple to use. Turn your network into a steady
                source of income with Bangladesh’s best e-commerce website builder.
                <br />
                <a
              ...
              <>
                eBitans স্বাগতম জানায় সকলকে, যার মধ্যে রয়েছেন দোকান মালিক, ওয়েবসাইট ম্যানেজার,
                প্রভাবক, ব্লগার, বিক্রয় গ্র্যাজুয়েট, এবং ফ্রিল্যান্সার। শুরু করার জন্য কোনো
                অভিজ্ঞতার প্রয়োজন নেই। এটি সম্পূর্ণ বিনামূল্যে এবং ব্যবহার করতে সহজ। আপনার
                নেটওয়ার্ককে বাংলাদেশের সেরা ই-কমার্স ওয়েবসাইট নির্মাণ প্ল্যাটফর্মের সাথে একটি
                স্থির আয়ের উৎসে পরিণত করুন।
                <br />
                <a
                  href="https://www.ebitans.com.bd/"
                  target="_blank"
